...
function MatchCard({ match, onDelete, onUpdate }) {
  ...
  // YENİ: Kart sayılarını tutan state'ler
  ...
  const handleSave = () => {
    onUpdate(match.id, { 
      ...
      score: score, 
      notes: notes, 
      yellowCards: parseInt(yellowCards) || 0, // Sayıya çeviriyoruz
      redCards: parseInt(redCards) || 0,       // Sayıya çeviriyoruz
      status: 'Oynandı' 
    });
    setIsEditing(false);
  };
      ...
      {isEditing ? (
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* YENİ: Kart Sayısı Giriş Alanları */}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <div className="w-full sm:w-auto mb-4 sm:mb-0">
            ...
            {/* YENİ: Kart Bilgilerini Kart Üzerinde Gösterme */}
          ...
          <div className="text-right flex flex-col items-end w-full sm:w-auto">
            ...
            <p className="font-black text-3xl text-gray-800 mb-3">{match.score || '- -'}</p>
